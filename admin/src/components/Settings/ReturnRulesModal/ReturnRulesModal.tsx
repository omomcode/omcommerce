...
export default function ReturnRulesModal({
  ...
  const handleSave = () => {
    editLegal({returnWindow: radioOne, returnShippingCost: radioTwo, restockingFee: restockingFee});
  };

  const handleNumberInputChange = (e: ChangeEvent<HTMLInputElement>) => {
    const {name, value} = e.target;
    setRestockingFee((prevState: any) => parseInt(value)
    );
  };
      ...
      >
        ...
        <ModalBody>
          <Grid padding={1}>
            ...
            <GridItem padding={1} col={8}>
              <RadioGroup labelledBy="return-window" onChange={(e: { target: { value: any; }; }) => setRadioOne(e.target.value)} value={radioOne}
                          name="radio-one">
            ...
            <GridItem padding={1} col={8}>
              ...
              <RadioGroup labelledBy="return-shipping-cost" onChange={(e: { target: { value: any; }; }) => setRadioTwo(e.target.value)} value={radioTwo}
                          name="radio-two">
            ...
            <GridItem padding={1} col={8}>
              <NumberInput name="restocking-fee"
                           onChange={handleNumberInputChange} value={restockingFee}/>
            </GridItem>
